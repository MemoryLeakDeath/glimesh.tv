defmodule Glimesh.Chat.Policy do
  ...
  def authorize(:view_viewer_list, %User{is_admin: true}, _channel), do: true
  ...
  def authorize(:view_viewer_list, %User{is_gct: true}, _channel), do: true
  ...
  def authorize(:view_viewer_list, %User{id: user_id}, %Channel{user_id: channel_user_id})
      when user_id == channel_user_id,
      do: true
  ...
  def authorize(:view_viewer_list, %User{} = user, %Channel{} = channel),
    do: Chat.can_moderate?(:can_delete, channel, user)
